...
class SystemTest extends \Codeception\TestCase\Test
{
    ...
    */
    ...
    {
        $cronJob = new \Sid\Phalcon\Cron\Job\System("* * * * *", "echo 'hello world'");
    ...
    {
        $systemCronJob = new \Sid\Phalcon\Cron\Job\System("* * * * *", "echo 'hello world'", "/dev/null");
    ...
    public function testSystemCronJobWithOutputToFile()
    {
        ...
        $systemCronJob = new \Sid\Phalcon\Cron\Job\System("* * * * *", "echo 'hello world'", $tmpName);
    ...
    public function testSystemCronJobsInForeground()
    {
        ...
        $systemCronJob1 = new \Sid\Phalcon\Cron\Job\System("* * * * *", "echo 'hello world 1'");
        $systemCronJob2 = new \Sid\Phalcon\Cron\Job\System("* * * * *", "echo 'hello world 2'");
        $systemCronJob3 = new \Sid\Phalcon\Cron\Job\System("* * * * *", "echo 'hello world 3'");
    ...
    {
        $systemCronJob = new \Sid\Phalcon\Cron\Job\System("* * * * *", "sleep 1", "/dev/null");
