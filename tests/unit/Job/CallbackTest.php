...
class CallbackTest extends \Codeception\TestCase\Test
{
    ...
    */
    ...
    {
        $cronJob = new \Sid\Phalcon\Cron\Job\Callback("* * * * *", function () { return "hello world"; });
    ...
    {
        $cronJob = new \Sid\Phalcon\Cron\Job\Callback("* * * * *", function () { sleep(1); });
    ...
    {
        $cronJob = new \Sid\Phalcon\Cron\Job\Callback("* * * * *", function () { sleep(2); });
